...
# ==============================================================================
# 1. SLUG AGGIORNATO PER IL MATCH DELLE 22:00
# ==============================================================================
ARTICLE_SLUG = "belgium-senegal-worldcup2026"

# Il link del feed si autogenera dinamicamente usando la variabile sopra
feed_url = (
    f"https://championsreport.editories.com/manual-articles/{ARTICLE_SLUG}/feed.xml"
)
